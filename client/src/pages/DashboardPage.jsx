...
{
    let { data: orderData, isLoading: orderLoading } = useQuery({
        queryKey: ["orders"],
        queryFn: orderApi.getAll
    });

    let { data: statsData, isLoading: statsLoading } = useQuery({
        queryKey: ["dashboardStats"],
        queryFn: statsApi.getDashboard
    });

    let recentOrders = orderData?.orders?.slice(0, 5) || [];
    ...
    return (
        <div
            ...
            <div
                ...
                { statsCards.map(stat => <StatCard stat={stat} key={stat.name} /> ) }
            </div>
